...
-   **Datum**: Un modelo matemático que define la forma de la Tierra. Existen dos tipos principales de datums:
    ...
    -   **Geodésicos**: Definen la forma de la Tierra para representar posiciones globales. Ejemplos incluyen WGS84 (usado por GPS) y NAD83. Verticales: Usados para medir elevaciones respecto a un nivel de referencia, como el nivel del mar. Sistema de Coordenadas: El sistema que especifica las coordenadas que se utilizan (como latitud y longitud en grados, o X e Y en metros).
...
PROJ (2024) — PROJ 9.4.1 Documentation (1983), <https://proj.org/en/9.4/index.html>
